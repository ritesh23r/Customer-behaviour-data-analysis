...
SELECT item_purchased , ROUND(AVG(review_rating::NUMERIC),1) FROM customer
...
SELECT customer_segment , COUNT(customer_id) AS number_of_customer FROM customer_type
...
SELECT item_RANK , category , item_purchased , total_order FROM count_item 
LIMIT 3;
